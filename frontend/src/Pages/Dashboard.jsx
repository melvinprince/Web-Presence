...
import { addOrUpdateUserDetails, getUserDetails, deleteEntry } from "../services/userDetailsService"; // Import deleteEntry
...
export default function Dashboard() { 
    ...
    const handleDeleteEntry = async (category, index) => {
        try {
            ...
            // 3. Update the Redux store (if needed)
                    ...
                    <ul> 
                        {userDetails.education.map((edu, index) => ( 
                            <li key={index}> 
                                ...
                                <button onClick={() => handleDeleteEntry('education', index)}>Delete Entry</button> {/* Delete button */}
                            </li> 
                        ))} 
                    </ul> 
                    ...
                    <ul> 
                        {userDetails.projects.map((project, index) => ( 
                            <li key={index}> 
                                ...
                                <button onClick={() => handleDeleteEntry('projects', index)}>Delete Entry</button> {/* Delete button */}
                            </li> 
                        ))} 
                    </ul> 
                    ...
                    <ul> 
                        {userDetails.experience.map((exp, index) => ( 
                            <li key={index}> 
                                ...
                                <button onClick={() => handleDeleteEntry('experience', index)}>Delete Entry</button> {/* Delete button */}
                            </li> 
                        ))} 
                    </ul> 
                </div> 
